# Blindspot Signals Report - 2026-06-23

**Source:** `/opt/apps/haier/exports/evolution_signals_20260623_020410.json`  
**Relevant Signals Found:** 681 (AI agents & decision delegation focus)
...
### 5. Deep Research in Physical Sciences: A Multi-Agent Framework and Comprehensive Benchmark
...
### 11. Trust Between AI Agents: Measuring Formation, Breakage, and Recovery, with Implications for Governing Multi-Agent Systems
...
### 12. RubricEM: Meta-RL with Rubric-guided Policy Decomposition beyond Verifiable Rewards
...
### 13. SubTGraph: Large-Scale Subterranean Environment Synthesis with Controllable Topological Variability for Robotic Autonomy Validation
...
### 14. Humanoid Whole-Body Manipulation via Active Spatial Brain and Generalizable Action Cerebellum
...
### 15. AutoMCU: Feasibility-First MCU Neural Network Customization via LLM-based Multi-Agent Systems
...
### 16. Auction-Consensus Algorithm with Learned Bidding Scheme for Multi-Robot Systems
...
### 17. Self-Evolving Multi-Agent Systems via Decentralized Memory
...
### 19. How to Steer Your Multi-Agent System: Human-LLM Collaborative Planning
...
### 20. Meta-Agent: From Task Descriptions to Verified Multi-Agent Systems
...
### 21. AgensFlow: A Coordination-Policy Substrate for Multi-Agent Systems
...
### 23. CARIBOU: Computational AI Research Interface for Bioinformatics, Omics, and Unifying Agents
...
### 25. MemGraphRAG: Memory-based Multi-Agent System for Graph Retrieval-Augmented Generation
...
### 26. Generative Multi-Robot Motion Planning via Diffusion Modeling with Multi-Agent Reinforcement Learning Guidance
...
### 27. Traj-Evolve: A Self-Evolving Multi-Agent System for Patient Trajectory Modeling in Lung Cancer Early Detection
...
### 30. Decentralized Multi-Agent Systems with Shared Context
